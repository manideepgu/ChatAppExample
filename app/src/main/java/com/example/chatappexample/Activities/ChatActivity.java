package com.example.chatappexample.Activities;
...
import com.example.chatappexample.adapters.ChatAdapter;
import com.example.chatappexample.databinding.ActivityChatBinding;
import com.example.chatappexample.models.ChatMessage;
import com.example.chatappexample.models.User;
import com.example.chatappexample.network.ApiClient;
import com.example.chatappexample.network.ApiService;
import com.example.chatappexample.utilities.Constants;
import com.example.chatappexample.utilities.PreferenceManager;
...
public class ChatActivity extends BaseActivity {
    ...
    private void init(){
        ...
        chatAdapter = new ChatAdapter(chatMessages,getBitmapfromEncodedString(recieverUser.image)
    ...
    private void checkForConversionRemotely(String senderId,String recieverId){
        database.collection(Constants.KEY_COLLECTION_CONVERSATIONS)
                ...
                .whereEqualTo(Constants.KEY_RECEIVER_ID,recieverId).get().addOnCompleteListener(conversionOnCompleteListener);
    }
